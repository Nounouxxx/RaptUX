...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("RaptUx") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "RaptUx", DisplayName = "RaptUx API", Resources = { "RaptUx" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var blazorServerTieredClientId = configurationSection["RaptUx_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["RaptUx_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["RaptUx_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
